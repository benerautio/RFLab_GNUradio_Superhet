...
class QAM_attempt(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "USRP TX 16QAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("USRP TX 16QAM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "QAM_attempt")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 500e6, 1, 0, 0)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 16, 10000))), True)
...
def main(top_block_cls=QAM_attempt, options=None):
